...
public class MenuController extends BaseController {
    ...
    @UserActionHandler(UserAction.ADD_MENU_ITEM)
    ...
    @UserActionHandler(UserAction.DELETE_MENU_ITEM)
    ...
    @UserActionHandler(UserAction.UPDATE_MENU_ITEM)
    ...
    @UserActionHandler(UserAction.GET_ALL_MENU_ITEMS)
    public String getAllMenuItems(@NotNull ParsedRequest request) throws SQLException {
    ...
    @UserActionHandler(UserAction.GET_MENU_ITEM_BY_NAME)
    ...
    @UserActionHandler(UserAction.GET_MENU_ITEM_BY_ID)
