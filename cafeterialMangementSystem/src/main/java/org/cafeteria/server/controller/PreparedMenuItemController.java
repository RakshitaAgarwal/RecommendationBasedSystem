...
public class PreparedMenuItemController extends BaseController {
    ...
    @UserActionHandler(UserAction.UPDATE_NEXT_DAY_FINAL_MENU)
    public String updateNextDayFinalMenu(@NotNull ParsedRequest request) throws SQLException {
